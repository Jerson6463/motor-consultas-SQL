...
// ejecutar corre el CLI capturando ambas salidas, sin entrada estandar.
func ejecutar(arguments ...string) (int, string, string) {
	return ejecutarCon("", arguments...)
}

// ejecutarCon corre el CLI alimentando la entrada estandar con un texto.
func ejecutarCon(entrada string, arguments ...string) (int, string, string) {
	var stdout, stderr bytes.Buffer
	code := Run(arguments, strings.NewReader(entrada), &stdout, &stderr)
