...
type Query struct {
	// Explain pide mostrar el plan en vez de ejecutarlo.
	Explain bool
...
// Identifier representa el nombre de una columna. Position conserva donde
// aparecio en el texto, para que los errores de las etapas posteriores puedan
// citarla igual que los del parser.
